  ...
  return (
    <footer id="footer" className="">
      <div
        className={
          theme === false
            ? "bg-primary bg-opacity-25 border-top border-secondary p-3 mt-5"
            : "bg-dark bg-opacity-75 border-top border-secondary p-3 mt-5"
        }
      >
      ...
      <div className="footer-copyright bg-primary bg-opacity-25">
        <div className="container">
          <div className="row">
